...
from zekam.infrastructure.sqlite import repository as sqlite_repository
    ...
    try:
        ...
        if context.settings.database.backend is PersistenceBackend.SQLITE:
            ...
            if (
                ...
                return
            console.print("uygulanacak: 0001_sqlite_minimum_profile")
            return
        current = _status(home)
    except ZekamError as exc:
        error_console.print(f"[red]Hata:[/red] {exc}")
...
def upgrade_command(
    ...
    try:
        ...
        if context.settings.database.backend is PersistenceBackend.SQLITE:
            ...
            console.print("[green]uygulandi:[/green] 0001_sqlite_minimum_profile")
            return
        with connect(context.settings.database) as connection:
