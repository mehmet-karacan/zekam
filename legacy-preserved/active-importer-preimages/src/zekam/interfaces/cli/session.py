...
from zekam.infrastructure.postgres.connection import PostgresRealmSessionOperations, connect
...
def assert_cli_invocation_backend(
    ...
    assert_cli_mutation_admission(
        ...
        supports_full_continuity=backend is PersistenceBackend.POSTGRESQL,
