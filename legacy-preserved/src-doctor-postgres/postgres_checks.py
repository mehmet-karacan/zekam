    ...
    def run(self) -> CheckResult:
        if PSYCOPG_AVAILABLE:
            return CheckResult(
                ...
                summary="zekam.application.local_runtime_boundary kullanilabilir",
                evidence={"driver": "zekam.application.local_runtime_boundary", "available": True},
            )
        return CheckResult(
            check_id=self.check_id,
            category=self.category,
            ...
            findings=(
                Finding(
                    ...
                    title="zekam.application.local_runtime_boundary yok",
                    detail="Kanonik depolama yetenegi kullanilamaz",
                    next_action="`pip install 'zekam[db]'` calistirin",
                ),
            ),
            evidence={"driver": "zekam.application.local_runtime_boundary", "available": False},
        )
