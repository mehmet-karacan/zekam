...
def test_local_driver_effect_marker_sonrasi_failed_output_receipt_yazmaz(
    ...
    monkeypatch.setattr(runtime, "AgentAssignmentRepository", lambda *args: assignments)
    policy_repository = Mock()
    monkeypatch.setattr(runtime, "PostgresLoopPolicyRepository", lambda *args: policy_repository)
