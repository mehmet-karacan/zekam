-- Capability request derivation v4.
-- Prior continuity is system-bound input; the model must not echo a digest field
-- that is forbidden by the exact public response schema.
    ...
    select jsonb_build_object(
        ...
        'messages',jsonb_build_array(
            ...
            jsonb_build_object(
                ...
                'semasina ek alan ekleme. Onceki continuity_state:' || chr(10) ||
